...
<style>
 	...
 	#arrastrar {
		...
		cursor:pointer;
                 background-image: url("images/jugadores/lebron_james_1.png");
		...
		cursor:pointer;
                 background-image: url("images/jugadores/jordan_1.png");
		...
		background-color: #990099;
		cursor:pointer;
                 background-image: url("images/jugadores/kobe_bryant_1.png");
		...
		background-color: #990099;
		cursor:pointer;
                 background-image: url("images/jugadores/irving_1.png");
		...
		cursor:pointer;
                 background-image: url("images/jugadores/pau_1.png");
